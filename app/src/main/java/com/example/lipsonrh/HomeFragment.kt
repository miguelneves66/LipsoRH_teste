...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // 1. Configuração do nome do usuário (Pedro Henrique)
        ...
        // 2. Configuração dos textos nos botões de serviço (Cards incluídos)
    ...
    private fun configurarBotoesServico(view: View) {
        // Lista com o ID do Card, o Texto e o Ícone correspondente
        ...
        dadosServicos.forEach { (idCard, titulo, idIcone) ->
            ...
            layoutBotao?.setOnClickListener {
                when (idCard) {
                    R.id.btnBeneficios -> {
                        // Navega para o BeneficiosFragment
                        parentFragmentManager.beginTransaction()
                            .replace(R.id.fragment_container, BeneficiosFragment())
                            .addToBackStack(null) // Permite que o usuário volte para a Home
                            .commit()
                    }
                }
            }
    ...
    // --- ADAPTADOR DO CARROSSEL (IMAGENS + CALENDÁRIO) ---
    inner class CarouselAdapter(private val imageList: List<Int>) :
        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            if (holder is ImageViewHolder) {
                ...
                // --- LÓGICA DE CLIQUE NO CALENDÁRIO ---
                holder.itemView.setOnClickListener {
                    parentFragmentManager.beginTransaction()
                        .replace(R.id.fragment_container, CalendarioDetalheFragment())
                        .addToBackStack(null)
                        .commit()
                }

                // Impede que o toque no calendário interno "roube" o clique do card
